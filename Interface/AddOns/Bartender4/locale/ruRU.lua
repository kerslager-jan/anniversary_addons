...
L["After disabling the Extra Action Bar, you should reload your UI to fully reset it to vanilla."] = "После отключения панели дополнительных действий вы должны перезагрузить пользовательский интерфейс, чтобы вернуть его к исходному виду."
...
L["Bars for Action Bar related UI elements"] = "Части пользовательского интерфейса для панели действий"
...
L["Bonus Action Bar"] = "Дополнительная панель действий"
L["Bonus Bar"] = "Дополнительная панель"
L["Both"] = "Оба"
L["BOTTOM"] = "НИЗ"
L["Bottom"] = "Внизу"
...
L["Buttons"] = "Кнопки"
L["Buttons are unlocked. While unlocked, actions will always execute on key release, instead of key press."] = "Кнопки разблокированы. Пока кнопки разблокированы, действия будут выполняться при отпускании клавиши, а не при нажатии."
L["By default this bar is used as the second page of the primary action bar."] = "По умолчанию эта панель используется как вторая страница основной панели действий."
...
L["Class Bar %d"] = "Панель класса %d"
L["Classic"] = "Классика"
L["Classic interface"] = "Классический интерфейс"
...
L["Configure Class Bar %d"] = "Настройка панели класса %d"
...
L["Configure the Bonus Action Bar"] = "Настройки дополнительной панели действий"
...
L["Configure the Totem Bar"] = "Настройка панели тотемов"
L["Configure the XP Bar"] = "Настроить панель опыта"
L["Contains the \"Green Eye\" when signing up for groups or raids"] = "Содержит \"Зеленый глаз\", отображаемый в поиске группы, подземелья и рейда."
...
L["Direction of the button flyouts on this bar (eg. summon demon/pet)"] = "Появление всплывающих кнопок на этой панели (например, для вызова демона/питомца)"
...
L["Enable the Pet Bar"] = "Включить панель питомца"
L["Enable the Queue Status Bar"] = "Включить панель состояния очереди"
...
L["Hide Border"] = "Скрыть границы"
L["Hide Equipped Border"] = "Скрыть рамку экипировки."
L["Hide Flyout Background"] = "Скрыть фон всплывающего окна"
...
L["Hide the background of the spell flyout frame."] = "Скрыть фон всплывающего окна заклинания."
L["Hide the border around the action button."] = "Скрыть рамку у кнопки действия."
...
L["Hotkey"] = "Горячие клавиши"
L["Hotkey Mode"] = "Режим горячих клавиш"
L["How do I change the Bartender4 Keybindings?"] = "Как изменить сочетания клавиш Bartender4?"
...
L["Lock the button contents from being dragged off. When locked, actions can still be dragged by holding Shift."] = "Заблокируйте кнопку действия от перетаскивания. Когда кнопка действия заблокирована, ее по-прежнему можно перетаскивать, удерживая клавишу Shift."
L["Macro Text"] = "Текст макроса"
L["Manage the abilities of your trusted companion"] = "Управляйте способностями вашего надежного спутника"
L["Manages the Backpack and all the extra bags"] = "Управляет рюкзаком и всеми дополнительными сумками"
L["Manages the Extra Action Button used in many quests and encounters, as well as Zone specific abilities"] = "Управляет кнопкой дополнительного действия, используемой во многих заданиях и встречах, а также способностями, специфичными для зоны."
L["Manages the Micro Menu buttons"] = "Управление кнопками микроменю"
L["Manages the Stance/Form buttons"] = "Управление кнопками стоек/обликов"
L["Micro Menu"] = "Микроменю"
L["Minimap Icon"] = "Иконка у мини-карты"
L["Modern"] = "Современный"
L["Modern Art, Classic"] = "Современный рисунок, классический"
L["Modern Art, Classic interface"] = "Современный рисунок, классический интерфейс"
L["Modern Blizzard interface"] = "Современный интерфейс Blizzard"
...
L["NOTE: It is strongly recommended to use Edit Mode to move the Extra Action Bar to avoid any complications in Raid Encounters, and leave the Bartender4 Extra Action Bar disabled."] = "ПРИМЕЧАНИЕ: Настоятельно НЕ рекомендуется использовать режим редактирования для перемещения панели дополнительных действий, чтобы избежать каких-либо осложнений в рейдах и заданиях. Рекомендуется оставить панель дополнительных действий Bartender4 отключенной."
L["NOTE: When the buttons are unlocked, actions will always trigger on key release, instead of key press."] = "ПРИМЕЧАНИЕ: Когда кнопки разблокированы, действия будут выполняться при отпускании клавиши, а не при нажатии."
...
L["Select the color of this element"] = "Выберите цвет этого элемента"
L["Select the Focus-Cast Modifier"] = "Выбрать модификатор для прочтения заклинания на фокус"
L["Select the font for this text element"] = "Выберите шрифт для этого текстового элемента"
L["Select the Self-Cast Modifier"] = "Выбрать модификатор для прочтения заклинания на себя"
L["Select the type of outline"] = "Выбор типа контура"
L["Self-Cast by modifier"] = "Чтение на себя по модификатору"
L["Self-Cast Modifier"] = "Модификатор заклинания на себя"
L["Set the font size of this element"] = "Укажите размер шрифта этого элемента"
L["Set X offset from the anchor point"] = "Установить смещение по оси X от опорной точки"
L["Set Y offset from the anchor point"] = "Установить смещение по оси Y от опорной точки"
L["SHIFT"] = "Shift"
...
L["Show the Reagent Bag in One Bag mode"] = "Отображать сумку для реагентов в режиме объединенных сумок"
...
L["The Blizzard Art Bar manages the background artwork to re-create a good looking bottom action bar cluster"] = "Панель Blizzard Art настраивает красивое фоновое изображение на нижней панели действий"
...
L["The Status Tracking Bar combines XP/Reputation/Honor into one bar, stacking up to two tracked elements"] = "Панель отслеживания состояния объединяет опыт/репутацию/честь в одну панель, отображая до двух отслеживаемых элементов."
L["The Vehicle Bar contains the \"Leave Vehicle\" button"] = "Панель транспорта содержит кнопку \"Покинуть транспорт\""
L["These options allow you to configure the font style and size used for all textual elements of the buttons on this bar."] = "Эти параметры позволяют вам настроить стиль и размер шрифта, используемый для всех текстовых элементов кнопок на этой панели."
...
L["Three bars stacked"] = "Три сложенные панели"
L["Three bars stacked (Classic)"] = "Три сложенные панели (Классический)"
...
L["Toggles actions immediately when you press the key, and not only on release. Note that the buttons need to be locked for actions to run on key press."] = "Переключает действия сразу при нажатии клавиши, а не только при отпускании. Обратите внимание, что кнопки должны быть заблокированы, чтобы действия выполнялись при нажатии клавиш."
L["TOP"] = "ВЕРХ"
L["Top"] = "Вверху"
...
L["Two bars wide (Classic)"] = "Две панели в ширину (Классический)"
L["UI Bars"] = "Панели пользовательского интерфейса"
L["Up"] = "Вверх"
...
L["Use three stacked action bars"] = "Используйте три расположенные друг над другом панели действий"
L["Usually used for druid shapeshift forms, but can be re-used for additional bars on other classes"] = "Обычно используется для панели форм друида, но может быть также использован как дополнительная панель на других классах"
